...
const DEMO_CASES: DemoCase[] = [
  ...
  {
    id: "VT-2026-0038", name: "Nour El-Din Sara", age: 8, gender: "F",
    location: "Giza - Haram Street", city: "Giza", timeAgo: "5 days ago",
    status: "MISSING", confidence: 91,
    description: "Child separated from family near Haram Street market. High-priority case.",
    timeline: [
      { time: "5d ago", event: "Child reported missing" },
      { time: "5d ago", event: "Amber-style alert dispatched to all Giza nodes" },
      { time: "3d ago", event: "Match candidate · 91% — pending verification" },
    ],
  },
  {
    id: "VT-2026-0035", name: "Hassan Ibrahim", age: 67, gender: "M",
    location: "Alexandria - Corniche", city: "Alexandria", timeAgo: "1 day ago",
    status: "FOUND", confidence: 96.4,
    description: "Elderly man with memory condition. Located safe by Corniche patrol.",
    timeline: [
      { time: "2d ago", event: "Reported missing by son" },
      { time: "1d ago", event: "Match · 96.4% — Corniche CCTV node" },
      { time: "1d ago", event: "Reunited with family ✓" },
    ],
  },
  {
    id: "VT-2026-0033", name: "Layla Mahmoud", age: 19, gender: "F",
    location: "Mansoura - University", city: "Mansoura", timeAgo: "2 days ago",
    status: "KIDNAPPED", confidence: 84,
    description: "Student. Suspected abduction near campus gate B. Investigation active.",
    timeline: [
      { time: "2d ago", event: "Witness report filed" },
      { time: "2d ago", event: "Vehicle plate partial match logged" },
      { time: "1d ago", event: "Inter-governorate alert active" },
    ],
  },
  {
    id: "VT-2026-0029", name: "Omar Salah", age: 12, gender: "M",
    location: "Luxor - Tourist Area", city: "Luxor", timeAgo: "7 days ago",
    status: "MISSING", confidence: 67,
    description: "Lost in tourist district. Multiple low-confidence sightings reported.",
    timeline: [
      { time: "7d ago", event: "Reported missing" },
      { time: "5d ago", event: "Possible sighting · Karnak — 67% confidence" },
      { time: "2d ago", event: "Search expanded to Aswan corridor" },
    ],
  },
];
